...
namespace CheatSheetProject.Repositories
{
    public class Migrations
    {
        ...
        public static void run()
        {
            ...
            SQLTableManagement.ExecuteSQL("CREATE TABLE Topic (Id VARCHAR(20), Name VARCHAR(200), OrderNumber INT, PRIMARY KEY (ID));");
            SQLTableManagement.ExecuteSQL("DROP TABLE CheetSheetItem");
            SQLTableManagement.ExecuteSQL("CREATE TABLE CheetSheetItem (Id VARCHAR(20) not null, Name VARCHAR(200), CodeSnippet TEXT, AdditionalInfo  TEXT, TopicId VARCHAR(20), OrderNumber INT, \nPRIMARY KEY (ID),\nFOREIGN KEY(TopicId) REFERENCES Topic(Id));");
